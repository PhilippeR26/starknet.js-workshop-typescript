...
# Typescript code, using Starknet.js v6.11.0 and local Starknet-devnet-rs 0.1.2
...
This script has been written with cairo v0.13.1, Starknet-devnet-rs v0.1.2, starknet.js v6.11.0. Due to fast iterations of Starknet and Cairo, these scripts will probably be quickly out-of-date.
