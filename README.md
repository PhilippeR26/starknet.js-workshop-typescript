...
# Typescript code, using Starknet.js v7.5.0 and local Starknet-devnet 0.4.2
...
This script has been written with cairo v0.13.5, Starknet-devnet v0.4.2, starknet.js v7.5.0. Due to fast iterations of Starknet and Cairo, these scripts will probably be quickly out-of-date.
