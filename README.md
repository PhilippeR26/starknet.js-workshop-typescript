...
# Typescript code, using Starknet.js v6.10.0 and local Starknet-devnet-rs 0.0.7
...
This script has been written with cairo v0.13.1, Starknet-devnet-rs v0.0.7, starknet.js v6.10.0. Due to fast iterations of Starknet and Cairo, these scripts will probably be quickly out-of-date.
