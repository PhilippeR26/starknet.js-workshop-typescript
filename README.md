...
# Typescript code, using Starknet.js v7.0.1 and local Starknet-devnet-rs 0.3.0
...
This script has been written with cairo v0.13.5, Starknet-devnet-rs v0.3.0, starknet.js v7.0.1. Due to fast iterations of Starknet and Cairo, these scripts will probably be quickly out-of-date.
