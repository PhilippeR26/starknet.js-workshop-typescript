// From OpenZeppelin Contracts for Cairo v2.0.0 (account/src/interface.cairo)
// Coded with Cairo v2.12.0
...
#[starknet::interface]
pub trait IDeployableSpecial<TState> {
    /// Validates a transaction before deployment.
    /// This function is used by the protocol to verify `deploy_account` transactions.
    ///
    /// Returns the short string 'VALID' if valid, otherwise it reverts.
    fn __validate_deploy__(
        self: @TState, class_hash: felt252, contract_address_salt: felt252, public_key: felt252, hardware_public_key: felt252,
    ) -> felt252;
}
