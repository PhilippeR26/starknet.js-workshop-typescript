...
async function main() {
    ...
    const compiledSierra = json.parse(fs.readFileSync("./compiledContracts/cairo240/poseidon.sierra.json").toString("ascii"));
    const compiledCasm = json.parse(fs.readFileSync("./compiledContracts/cairo240/poseidon.casm.json").toString("ascii"));
