...
import { constants, Contract, Account, json, shortString, RpcProvider, RPC, num, transaction, CallData, selector } from "starknet";
import fs from "fs";
...
async function main() {
    ...
    const compiledSierra = json.parse(fs.readFileSync("./compiledContracts/cairo240/counter2.sierra.json").toString("ascii"));
