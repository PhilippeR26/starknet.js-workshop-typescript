...
async function main() {
    ...
    const accountAddress0 = "0x064b48806902a367c8598f4f95c305e8c1a1acba5f082d294a43793113115691";
    const privateKey0 = "0x0000000000000000000000000000000071d7bb07b9a64f6f78ac4c816aff4da9";
    // **** Sepolia
    ...
    const accountAddress2 = "0x049dfb8ce986e21d354ac93ea65e6a11f639c1934ea253e5ff14ca62eca0f38e";

    const strkSierra=await myProvider.getClassAt(strkAddress);
    const strkContract = new Contract(strkSierra.abi, strkAddress, myProvider);
    console.log(strkContract.functions);
