...
async function main() {
  ...
  const resp6 = await account2.execute([approvePoolCall2, delegateCall], { skipValidate: false });
  ...
  const resp20 = await account0.execute(updateCommissionCall, { skipValidate: false });
  ...
  const resp9 = await account2.execute([approvePoolCall1, IncreasePollCall], { skipValidate: false });
  ...
  const resp12 = await account2.execute(claimPoolCall, { skipValidate: false });
  ...
  const resp10 = await account2.execute(partialWithdrawInitCall, { skipValidate: false });
  ...
  const resp11 = await account2.execute(undelegateAction1Call, { skipValidate: false });
  ...
  const resp7 = await account2.execute(totalWithdrawInitCall, { skipValidate: false });
  ...
  const resp8 = await account2.execute(undelegateActionCall, { skipValidate: false });
  ...
  const resp4 = await account0.execute(unstakeActionCall, { skipValidate: false });
