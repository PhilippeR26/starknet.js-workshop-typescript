...
// Launch with npx ts-node src/scripts/Starknet135/Starknet135-Sepolia/12.paymasterSNIP-29SelfDeployAccountOZ.ts
// Coded with Starknet.js v7.1.0 + experimental

import { RpcProvider, shortString, json, logger, Account, PaymasterRpc, Contract, cairo, constants, RPC, RPC07, OutsideExecutionVersion, num, type TokenData, type PaymasterFeeEstimate, hash, ec, stark, CallData, type DeployTransaction, type ExecutableDeployTransaction, type PreparedTransaction, type ExecutableUserTransaction } from "starknet";
import fs from "fs";
