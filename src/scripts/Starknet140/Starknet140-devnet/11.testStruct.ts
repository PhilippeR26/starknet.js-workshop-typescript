...
async function main() {
    ...
    console.log(struct10.toApiRequest());
    console.log(struct10.decompose(strategies));
    ...
    console.log(struct11.toApiRequest());
    console.log(struct11.decompose(strategies));
    ...
    console.log(struct12.toApiRequest());
    console.log(struct12.decompose(strategies));
    ...
    //         ]
    //     } ;
    const struct1 = new CairoStruct({ thickness: 8, position: struct10 }, abiStruct2!, strategies);
    console.log(LogC.bg.yellow, "struct1 =", LogC.reset, struct1);
    console.log(struct1.toApiRequest());
    console.log(struct1.decompose(strategies));

    const struct1a = new CairoStruct({ thickness: 8, position: { x: 1, y: 2 } }, abiStruct2!, strategies);
    console.log(LogC.bg.yellow, "struct1a =", LogC.reset, struct1a);
    console.log(struct1a.toApiRequest());
    console.log(struct1a.decompose(strategies));
    ...
    console.log(struct1b.toApiRequest());
    console.log(struct1b.decompose(strategies));
    ...
    console.log(LogC.bg.yellow, "tup3 =", LogC.reset, struct3);
    console.log(struct3.toApiRequest());
    console.log(struct3.decompose(strategies));

    // CairoStruct including a fixed array
    type Horse = {
        age: BigNumberish,
        leg_color: BigNumberish[],
    }
    const myHorse: Horse = { age: 2, leg_color: [5, 6, 7, 8] };
    ...
    console.log(struct4.toApiRequest());
    console.log(struct4.decompose(strategies));
    ...
    console.log(struct5.toApiRequest());
    console.log(struct5.decompose(strategies));
    ...
    console.log(struct6.toApiRequest());
    console.log(struct6.decompose(strategies));
