...
// launch with : npx ts-node src/scripts/Starknet140/Starknet140-devnet/3.Challenge10txs.ts
...
async function main() {
    ...
    const gameContract = new Contract({
        ...
        address: deployResponse.contract_address, providerOrAccount: account0
    });
    ...
    console.log("Final quantity of weapons", finalWeapons);
