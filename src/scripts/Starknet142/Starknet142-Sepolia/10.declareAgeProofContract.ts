...
// launch with npx src/scripts/Starknet142/starknet142-Sepolia/10.declareAgeProofContract.ts
...
async function main() {
  ...
  const compiledCasm = json.parse(fs.readFileSync("./compiledContracts/cairo2170/proof_of_age_PrivateVoteVerifierMultiRound.compiled_contract_class.json").toString("ascii")) as CairoAssembly;
  ...
  // proof contract 
  // classH = 0x560f1eac1cb8a573985f27c91a456cc948c0bd0ed5da6cf863d1a2f341b38d4
  // address = 0x33a7db6d88a56b30a96dbea80ef5eef59b70deeb8081ff8a090cd95be081d67
