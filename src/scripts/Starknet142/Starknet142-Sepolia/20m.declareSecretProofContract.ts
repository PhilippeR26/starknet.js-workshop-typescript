...
// launch with npx ts-node src/scripts/Starknet142/Starknet142-Sepolia/20.declareSecretProofContract.ts
...
async function main() {
  ...
  // address = 0x748f59171d32188f023fe2dfcdc86fe7a733e95866349f9037db2d24535c303
