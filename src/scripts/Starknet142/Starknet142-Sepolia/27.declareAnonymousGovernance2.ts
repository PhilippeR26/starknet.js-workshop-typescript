...
// launch with npx ts-node src/scripts/Starknet142/Starknet142-Sepolia/27.declareAnonymousGovernance2.ts
...
async function main() {
  ...
  const compiledCasm2 = json.parse(fs.readFileSync("./compiledContracts/cairo2180/erc20_anon_gov_AnonGovernor2.compiled_contract_class.json").toString("ascii")) as CairoAssembly;
