...
// launch with npx src/scripts/Starknet142/Starknet142-devnet/4.declareAnonymousGovernance.ts
...
async function main() {
  ...
  // address = 0x3e406880811cf5b686a95b74713c831625ea8e7316501a8db3f5bae5914d5a5
...
const constructor2 = governorCallData.compile("constructor", {
  ...
  // addr = 0x5bc8fba36ce3eb160e8af98f56d46c862c3711d2ba10af6662c8bd775081068

  console.log("✅ Test completed.");
  // =====================================================
  // ⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️
  // As starknet-devnet is not using properly proofs, we can't go further in this network.
  // =====================================================
}
main()
  .then(() => process.exit(0))
