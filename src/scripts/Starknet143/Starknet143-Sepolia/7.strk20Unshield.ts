...
async function main() {
    ...
    // The pool must already exist (deployed by script 4 or 5) — nothing to unshield otherwise.
    ...
    if (change > 0n && selfChannel === undefined) {
        throw new Error("Change needed but no self channel found (open it with script 4 or 5), " +
