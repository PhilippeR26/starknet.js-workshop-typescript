...
import { AccountInvocationsFactoryDetails, AllowArray, BigNumberish, BlockIdentifier, BlockNumber, Call as Call$1, CallDetails, CallResult, ProviderInterface, SignerInterface, constants } from 'starknet';
...
declare const TXN_TYPE_L1_HANDLER = "L1_HANDLER";
...
declare const ABI_TYPE_ENUM = "enum";
 ...
 */
export type ABI = Array<FUNCTION | CONSTRUCTOR | L1_HANDLER | EVENT$1 | STRUCT | ENUM | INTERFACE | IMPL>;
...
export type WebSocketMethods = {
	...
	starknet_subscribeNewHeads: {
		...
		errors: TOO_MANY_BLOCKS_BACK | BLOCK_NOT_FOUND;
		/**
	...
	starknet_subscribeEvents: {
		...
		result: SUBSCRIPTION_ID;
		errors: TOO_MANY_KEYS_IN_FILTER | TOO_MANY_BLOCKS_BACK | BLOCK_NOT_FOUND;
		/**
	...
	starknet_unsubscribe: {
		...
		result: Boolean;
		errors: INVALID_SUBSCRIPTION_ID;
	};
};
/**
 * Account Address
...
declare const TypedDataRevision: {
	readonly ACTIVE: "1";
	readonly LEGACY: "0";
};
...
export interface RpcTypeToMessageMap {
	...
	wallet_watchAsset: {
		...
		result: boolean;
		errors: NOT_ERC20 | INVALID_REQUEST_PAYLOAD | USER_REFUSED_OP | API_VERSION_NOT_SUPPORTED | UNKNOWN_ERROR;
	};
	/**
	...
	wallet_addStarknetChain: {
		...
		result: boolean;
		errors: INVALID_REQUEST_PAYLOAD | USER_REFUSED_OP | API_VERSION_NOT_SUPPORTED | UNKNOWN_ERROR;
	};
	/**
	...
	wallet_switchStarknetChain: {
		...
		result: boolean;
		errors: UNLISTED_NETWORK | USER_REFUSED_OP | API_VERSION_NOT_SUPPORTED | UNKNOWN_ERROR;
	};
	/**
	...
	wallet_deploymentData: {
		...
		errors: ACCOUNT_ALREADY_DEPLOYED | API_VERSION_NOT_SUPPORTED | UNKNOWN_ERROR;
	};
	/**
...
interface TRANSACTION_EXECUTION_ERROR$1 {
	code: 156;
...
type AccountDeploymentData$1 = ACCOUNT_DEPLOYMENT_DATA;
type ReadMethods$1 = {
	...
	paymaster_buildTransaction: {
		...
		errors: INVALID_ADDRESS | CLASS_HASH_NOT_SUPPORTED | INVALID_DEPLOYMENT_DATA | TOKEN_NOT_SUPPORTED | INVALID_TIME_BOUNDS | UNKNOWN_ERROR$1 | TRANSACTION_EXECUTION_ERROR$1;
	};
...
type WriteMethods$1 = {
	...
	paymaster_executeTransaction: {
		...
		errors: INVALID_ADDRESS | CLASS_HASH_NOT_SUPPORTED | INVALID_DEPLOYMENT_DATA | INVALID_SIGNATURE | UNKNOWN_ERROR$1 | MAX_AMOUNT_TOO_LOW | TRANSACTION_EXECUTION_ERROR$1;
	};
};
type Methods$1 = ReadMethods$1 & WriteMethods$1;
...
export interface ProveInterface {
	 ...
	 */
	prove(calls: AllowArray<Call$1>): Promise<Proof>;
}
...
declare namespace CONTRACT {
	export { ABI, CONSTRUCTOR, ENUM, ENUM_EVENT, EVENT$1 as EVENT, EVENT_FIELD, EVENT_KIND, FUNCTION, IMPL, INTERFACE, L1_HANDLER, STRUCT, STRUCT_EVENT };
}
declare namespace WALLET_API {
	export { ACCOUNT_ALREADY_DEPLOYED, API_VERSION, API_VERSION_NOT_SUPPORTED, AccountChangeEventHandler, AccountDeploymentData, AddDeclareTransactionParameters, AddDeclareTransactionResult, AddInvokeTransactionParameters, AddInvokeTransactionResult, AddStarknetChainParameters, Address, ApiVersionRequest, Asset, BLOCK_TIMESTAMP, Call, INVALID_REQUEST_PAYLOAD, IsParamsOptional, NOT_ERC20, NetworkChangeEventHandler, OutsideCallV1, OutsideCallV2, OutsideExecutionMessageV1, OutsideExecutionMessageV2, OutsideExecutionTypedData, OutsideExecutionTypedDataV1, OutsideExecutionTypedDataV2, PADDED_FELT, PADDED_TXN_HASH, Permission, RequestAccountsParameters, RequestFn, RequestFnCall, RpcMessage, RpcTypeToMessageMap, Signature, SpecVersion, StarknetChain, StarknetDomain, StarknetEnumType, StarknetMerkleType, StarknetType, StarknetWindowObject, SwitchStarknetChainParameters, TIME_BOUNDS, TokenSymbol, TypedData, TypedDataRevision, UNKNOWN_ERROR, UNLISTED_NETWORK, USER_REFUSED_OP, WalletEventHandlers, WalletEventListener, WalletEvents, WatchAssetParameters };
}
