...
// launch with npx ts-node src/scripts/merkleTree/airdropSJS6Sepolia/1a.createTreePedersen.ts
...
async function main() {
    ...
    fs.writeFileSync('./src/scripts/merkleTree/airdropSJS6Sepolia/treeListAddressSepoliaPedersen.json', JSON.stringify(tree1.dump(),undefined,2));
