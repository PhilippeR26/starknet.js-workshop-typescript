...
import { account1OZSepoliaAddress, account1OZSepoliaPrivateKey, account2TestBraavosSepoliaAddress, account2TestBraavosSepoliaPrivateKey } from "../../../A1priv/A1priv.js";
import { account1IntegrationOZ8address, account1IntegrationOZ8privateKey, account3IntegrationOZ17address, account3IntegrationOZ17privateKey } from "../../../A2priv/A2priv.js";
...
console.log(0.290322427490426970-0.043380613574768736+0.009);
    process.exit(5);
    // *** Devnet
    ...
    const respTransfer = await strkContract.withOptions({ skipValidate: false }).transfer(account0.address, 1n * 10n ** 2n);
...
// 0.043380613574768736
// const a=0.290322427490426970-0.043380613574768736+0.009