...
// launch with npx src/scripts/starknet142/starknet142-integrationSepolia/2.declareProofContract.ts
...
import { account1IntegrationOZ8address, account1IntegrationOZ8privateKey, account3IntegrationOZ17address, account3IntegrationOZ17privateKey, accountIntegrationAdrienAddress, accountIntegrationAdrienPrivateKey, AdrienIntegrationUrl } from "../../../A2priv/A2priv";
...
async function main() {
  ...
  const myProvider = new RpcProvider({ nodeUrl: AdrienIntegrationUrl }); // local Sepolia Integration node
